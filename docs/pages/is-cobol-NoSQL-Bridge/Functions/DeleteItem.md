...
The DeleteItem function deletes a record from the file.
...
| condition | Condition that must be true to confirm the deletion of the record.Refer to [Condition syntaxes](./Functions#condition-syntaxes) for the syntax you can use for this parameter. This parameter is optional |
| | |
