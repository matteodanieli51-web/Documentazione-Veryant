...
A JDK must be installed on your machine in order to use isCOBOL EIS. For best results and performance, install the latest JDK version available for your platform.
