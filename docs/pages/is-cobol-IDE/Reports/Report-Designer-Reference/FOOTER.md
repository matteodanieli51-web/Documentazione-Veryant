...
| print after page footer | TRUE...The report header prints after the page footer on the last page of the report.FALSE...The report header prints before the page footer on the last page of the report. |
