...
| print before page header | TRUE...The report header prints before the page header on the first page of the report.<br>FALSE...The report header prints after the page header on the first page of the report. |
