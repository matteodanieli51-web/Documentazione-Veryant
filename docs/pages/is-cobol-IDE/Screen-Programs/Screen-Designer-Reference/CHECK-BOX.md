...
Refer to [CHECK-BOX](../../../is-cobol-evolve/User-Interface/Controls-Reference/CHECK-BOX/CHECK-BOX) for details about properties, styles and events of this control.
...
| auto-fit | TRUE... The image is scaled in order to fit the control boundaries. This is achieved through additional code generated in the Procedure Division.<br>FALSE...The image is shown as is, if it’s too large for control boundaries, it will be truncated. |
...
| check-off-value | Specifies the value for the *Check-Off-Value* property |
| check-on-value | Specifies the value for the *Check-On-Value* property |
...
| vtop | TRUE...The *Vtop* style is generated<br>FALSE...The *Vtop* style is not generated |
...
| check-off-value variable | Alphanumeric variable that hosts the value for the *Check-Off-Value* property |
| check-on-value variable | Alphanumeric variable that hosts the value for the *Check-On-Value* property |
