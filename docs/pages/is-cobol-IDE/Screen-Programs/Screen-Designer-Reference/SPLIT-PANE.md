...
Refer to [SPLIT-PANE](../../../is-cobol-evolve/User-Interface/Controls-Reference/SPLIT-PANE/SPLIT-PANE) for details about properties, styles and events of this control.
...
| divider location | Specifies the value of the *Divider-Loction* property |
| divider size | Specifies the value of the *Divider-Size* property |
...
| max divider location | Specifies the value of the *Max-Divider-Loction* property |
...
| min divider location | Specifies the value of the *Min-Divider-Loction* property |
...
| orientation | Specifies the value of the *Split-Orientation* property |
...
| ntf-sp-resized event | Allows the user to create a paragraph to handle the NTF-SP-RESIZED event in the Procedure Division |
| other event | Allows the user to create a custom paragraph |

| Exceptions | |
| --- | --- |
| ntf-sp-resized exception | Allows the user to create a paragraph to handle the NTF-SP-RESIZED event when the Accept terminates with crt status = 96. This is an alternative to the event procedures described above |
...
| divider location variable | Numeric variable that hosts the value for the Divider-Location property |
| divider size variable | Numeric variable that hosts the value for the Divider-Size property |
...
| max divider location variable | Numeric variable that hosts the value for the Max-Divider-Location property |
...
| min divider location variable | Numeric variable that hosts the value for the Min-Divider-Location property |
...
| style variable | Numeric variable that hosts the value for the Style property |
