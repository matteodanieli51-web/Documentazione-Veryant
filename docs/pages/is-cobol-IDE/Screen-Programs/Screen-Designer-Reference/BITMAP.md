...
Refer to [BITMAP](../../../is-cobol-evolve/User-Interface/Controls-Reference/BITMAP/BITMAP) for details about properties, styles and events of this control.
...
| bitmap end | Specifies the value for the *Bitmap-End* property. |
...
| bitmap start | Specifies the value for the *Bitmap-Start* property. |
| bitmap timer | Specifies the value for the *Bitmap-Timer* property. |
...
| event list | Opens a dialog that allows you to choose which events must be added to the event list of this control. <br>![](../../images/IDE-bmp-eventlist.png) |
...
| Variables | |
| --- | --- |
| bitmap end variable | Numeric variable that hosts the value for the *Bitmap-End* property. |
...
| bitmap start variable | Numeric variable that hosts the value for the *Bitmap-Start* property. |
| bitmap timer variable | Numeric variable that hosts the value for the *Bitmap-Timer* property. |
| color variable | Numeric variable that hosts the color value. |
| column variable | Numeric variable that hosts the column value. |
| css-style-name variable | Alphanumeric variable that hosts the css style associated with the control. It works only in a WWebDirectebDirect environment. |
