...
Refer to [SLIDER](../../../is-cobol-evolve/User-Interface/Controls-Reference/SLIDER/SLIDER) for details about properties, styles and events of this control.
...
| inverted | TRUE...The *Inverted* style is generated<br>FALSE...The *Inverted* style is not generated |
| key | Specifies the value for the *Key* property. |
| labels increment | Specifies the value for the *Labels-Increment* property |
...
| major tick spacing | Specifies the value for the *Major-Tick-Spacing* property |
...
| show labels | TRUE...The *Show-Labels* style is generated<br>FALSE...The *Show-Labels* style is not generated |
| show ticks | TRUE...The *Show-Ticks* style is generated<br>FALSE...The *Show-Ticks* style is not generated |
...
| msg-sl-thumb event | Allows the user to create a paragraph to handle the MSG-SL-THUMB event in the Procedure Division |
...
| labels increment variable | Numeric variable that hosts the value for the *Labels-Increment* property |
...
| major tick spacing variable | Numeric variable that hosts the value for the *Major-Tick-Spacing* property |
