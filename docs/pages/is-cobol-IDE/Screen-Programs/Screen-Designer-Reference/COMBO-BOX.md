...
Refer to [COMBO-BOX](../../../is-cobol-evolve/User-Interface/Controls-Reference/COMBO-BOX/COMBO-BOX) for details about properties, styles and events of this control.
...
| item-height | Specifies the value for the *Item-Height* property expressed in cells |
| item-height pixels | Specifies the value for the *Item-Height* property expressed in pixels |
| item-to-add | Opens a dialog that allows the user to set the text and icon for each single item. <br>![](../../images/ide-prop-itemadd-cb.png) |
...
| style | DROP-DOWN... The *Drop-Down* style is generated<br>DROP-LIST... The *Drop-List* style is generated |
...
| input-filter | Alphanumeric variable that hosts the value for the *Input-Filter* property |
| item-height variable | Numeric variable that hosts the value for the *Item-Height* property |
