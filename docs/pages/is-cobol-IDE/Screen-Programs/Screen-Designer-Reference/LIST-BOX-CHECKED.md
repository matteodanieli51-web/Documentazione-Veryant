...
| selection-mode | SINGLE-SELECTION...Shows radio buttons before items. Only one item can be selected.<br>MULTIPLE-SELECTION...Shows check boxes before items. Multiple items can be selected. |
