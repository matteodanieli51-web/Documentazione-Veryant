...
| active-tab-border-color | Opens a dialog that allows the user to choose the border color for the active tab. <br>![](../../../images/ide-prop-dtfg.png) |
| active-tab-border-width | Opens a dialog that allows the user to choose the border width for the active tab. <br>![](../../../images/IDE-borderwidth.png) |
...
| allow-container | TRUE...The *Allow-Container* style is generated. As a consequence, the code generated to manage the tab switch will use this style.<br>FALSE...The *Allow-Container* style is not generated. As a consequence, the code generated to manage the tab switch will use the visible variables and CMD-TABCHANGED event. |
...
| fixed-width | TRUE...The *Fixed-Width* style is generated<br>FALSE...The *Fixed-Width* style is not generated |
...
| hot-track | TRUE...The *Hot-Track* style is generated<br>FALSE...The *Hot-Track* style is not generated |
...
| no-box | TRUE...The *No-Box* style is generated<br>FALSE...The *No-Box* style is not generated |
...
| tab orientation | Allows the user to choose one of the following styles:<br>TOP<br>VERTICAL LEFT<br>VERTICAL RIGHT<br>BOTTOM |
| text-norotate | TRUE... The *Text-Norotate* style is generated<br>FALSE.. The *Text-Norotate* style is not generated |
