...
By default, the IDE automatically selects the generated source code after the code generation is complete. This will allow you to quickly compile your code without having to select it from the [isCOBOL Explorer](\) tree. If you wish to disable this feature, uncheck the option “Allow selection in the isCOBOL Explorer after generation”.
