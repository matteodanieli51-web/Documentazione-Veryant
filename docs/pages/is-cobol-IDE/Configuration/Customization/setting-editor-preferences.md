...
The general Colors and Fonts panel allows you to configure fonts and colors for the variables highlight and tool-tips shown in the Code Editor![](img/IDE-gnrl-fonts.PNG)
