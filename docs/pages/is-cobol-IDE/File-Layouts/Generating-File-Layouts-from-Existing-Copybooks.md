...
3. Choose *isCOBOL / isCOBOL Select FD copy files* from the tree.![](../images/ImportFdSl.png)
4. Browse to find the folder containing the copybooks, check the ones that you wish to import and click *Finish*.![](../images/ImportFdSl_b.png)
