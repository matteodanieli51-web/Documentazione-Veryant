...
A JRE must be installed on your machine in order to use isCOBOL WebClient. For best results and performance, install the latest JDK version available for your platform.

isCOBOL WebClient is certified for use with both Oracle JDK and OpenJDK, supporting the following LTS versions: 8, 11, 17, and 21.
