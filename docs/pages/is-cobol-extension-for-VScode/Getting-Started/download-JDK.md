...
A JDK must be installed on your machine in order to use the Veryant isCOBOL extension. For best results and performance, install the latest JDK version available for your platform. isCOBOL is certified to work correctly with both Oracle JDK and OpenJDK from version 8 to version 21.
