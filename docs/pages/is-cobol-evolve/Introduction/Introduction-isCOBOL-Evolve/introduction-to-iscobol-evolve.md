...
- isCOBOL EIS – an umbrella of tools and features that allows development and execution of a web based application in a Jakarta container. It includes Web Direct 2.0, a Web 2.0 solution which utilizes Asynchronous Javascript and XML (AJAX) technology to enable quick deployment of fully-interactive COBOL programs for the Web without changing basic application structure.
