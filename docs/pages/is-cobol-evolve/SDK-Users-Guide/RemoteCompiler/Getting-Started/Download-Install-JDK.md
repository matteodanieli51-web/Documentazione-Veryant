...
A JDK must be installed on your machine in order to use isCOBOL RemoteCompiler. For best results and performance, install the latest JDK version available for your platform.
